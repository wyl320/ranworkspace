...
export default {
  ...
  methods: {
    ...
    keyUp: function() {
      // this.selectedEvent = "ddddd";
      // console.log("ssssss"+this.value);
      // this.$emit('increment',this.selectedEvent)
      this.selectedEvent = 'keyUp';
      console.log("eee"+this.selectedEvent)
    },
    keyDown: function() {
